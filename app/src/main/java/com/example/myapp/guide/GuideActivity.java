...
public class GuideActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    int resId[]={R.drawable.pic1,R.drawable.pic2,R.drawable.pic3};//所显示的图片资源数组
    private com.example.myapp.guide.GuideAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //创建适配器对象
        adapter = new com.example.myapp.guide.GuideAdapter(viewList);
        //设置适配器
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.guide_btn:
                Intent intent=new Intent(com.example.myapp.guide.GuideActivity.this, MainActivity.class);
